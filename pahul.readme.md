...
A beginner-friendly Python project for Transportation & Logistics. Enter two places and get the shortest path and travel time using Dijkstra's algorithm.
...
The project includes a sample graph in `sample_graph.json` for testing.
